package com.example.yavengy.hidemyteam.Parallax;
...
public class PEWTextView extends TextView {
    ...
    private void checkAttributes(AttributeSet attrs) {
        TypedArray arr = getContext().obtainStyledAttributes(attrs, com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs);
        int reverse = arr.getInt(com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs_reverse, 1);

        updateOnDraw = arr.getBoolean(com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs_update_onDraw, false);

        blockParallaxX = arr.getBoolean(com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs_block_parallax_x, false);
        blockParallaxY = arr.getBoolean(com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs_block_parallax_y, false);
        ...
        scrollSpaceX = arr.getDimensionPixelSize(com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs_parallax_x, 0);
        scrollSpaceY = arr.getDimensionPixelSize(com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs_parallax_y, 0);


        int interpolationId = arr.getInt(com.fmsirvent.ParallaxEverywhere.R.styleable.PEWAttrs_interpolation, 0);
